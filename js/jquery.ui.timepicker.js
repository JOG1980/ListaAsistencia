...
*/
        ...
        _generateHTMLHourCell: function (inst, hour, showPeriod, showLeadingZero) {
            ...
            if (hour == undefined) {
                html = '<td class="ui-timepicker-hour-cell"><a class="ui-state-default ui-state-disabled">&nbsp;</a></td>';
                return html;
            }
            ...
            if (enabled) {
            	...
            	html =
            		'<td class="ui-timepicker-hour-cell">' +
		                '<a class="ui-state-default ui-state-disabled ' +
		                (hour == inst.hours ? ' ui-state-active ' : ' ') +
		                '">' +
		                displayHour.toString() +
		                '</a>' +
        ...
        _generateHTMLMinuteCell: function (inst, minute, displayText) {
            ...
            if (enabled && hour !== null) {
             ...
             if (enabled) {
            	...
            	html = '<td class="ui-timepicker-hour-cell">' +
	                 '<a class="ui-state-default ui-state-disabled" >' +
	                 	displayText +
	                 '</a>' +
                 '</td>';
